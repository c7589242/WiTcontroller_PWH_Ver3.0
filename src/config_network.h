...
const int maxSsids = 8;

// There must be the same number of entities (specified above) in each of the following arrays

const String ssids[maxSsids] = {"ANP_Wi-Fi", "RPi-JMRI", "Belong3B2649", "Belong6169A6", "VNSC", "TTrak1", "T-TRAK-PWH01", "ttrak_coop_2G"};   // ANP, Default Rpi, New Home Router, Old Home Router, VNSC, T-TRAK Co-Operative Michaeal Treacy Router, T-TRAK C0-Operative PWH Router, T-TRAK Co-Operative BBCS.
const String passwords[maxSsids] = {"4472!357%", "rpI-jmri", "gy3bq7w89qz2ez4c", "hqbyee7xeb6t", "blueNgold", "TTrakCo2", "TTrakCo2", "exhibition"};  //
